 ...
 */
export function collectSignals(dir: string): CandidateSignals {
  ...
  if (lock !== undefined) signals.lockFile = lock
 ...
 */
export function scanCandidates(root: string): CandidateSignals[] {
...
function formatCandidates(value: { root: string; candidates: CandidateSignals[] }): string {
