...
export const WIN32_EDITOR_EXES = [
...
async function queryAppPath(facts, root, exe) {
    try {
        const { stdout } = await facts.run('reg', ['query', `${root}\\${exe}`, '/ve'], new AbortController().signal);
 ...
 */
export async function detectWin32Editor(facts, exe) {
 ...
 */
export async function detectWin32Editors(facts) {
    const result = {};
...
//# sourceMappingURL=editors-win32.js.map